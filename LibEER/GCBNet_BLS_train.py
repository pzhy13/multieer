...
#    deap dep
#    arousal
#    python GCBNet_BLS_train.py -metrics 'acc' 'macro-f1' -model GCBNet_BLS -metric_choose 'macro-f1' -setting deap_sub_dependent_train_val_test_setting -dataset_path /home/pzy/LibEER/LibEER/data_preprocessed_python -dataset deap -batch_size 512 -epochs 150 -lr 0.005 -time_window 1 -feature_type de_lds -bounds 5 5 -label_used arousal -seed 2024 -onehot >GCBNet_BLS/deap_arousal_b512e150lr0.005.log
...
#    both
#    CUDA_VISIBLE_DEVICES=2 nohup python GCBNet_BLS_train.py -metrics 'acc' 'macro-f1' -model GCBNet_BLS -metric_choose 'macro-f1' -setting deap_sub_dependent_train_val_test_setting -dataset_path /home/pzy/LibEER/LibEER/data_preprocessed_python -dataset deap -batch_size 256 -epochs 150 -lr 0.005 -time_window 1 -feature_type de_lds -bounds 5 5 -label_used valence arousal -seed 2024 -onehot >GCBNet_BLS/deap_both_b256e150lr0.005.log
